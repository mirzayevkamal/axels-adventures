...
label intro:
    ...
    show screen intro_text("Once upon a time, in the scorching heat of the Wild West, there was an army of soldiers tirelessly devoted to their country, bound by deep loyalty and serving its security.", 0.2) with dissolve
    $ renpy.pause(4.0)
    hide screen intro_text with dissolve

    show screen intro_text("The months they spent under harsh conditions, uncertain and brutal weather, hunger, and the longing for their families deeply shook them.", 0.2) with dissolve
    $ renpy.pause(4.0)
    hide screen intro_text with dissolve
...
scene story_3 at pan_zoom with dissolve
    ...
    show screen intro_text("And, despite all these traits, incredibly attractive in his ruggedness.", 0.85) with dissolve
    $ renpy.pause(4.0)
    hide screen intro_text with dissolve
...
scene story_4
    ...
    show screen intro_text("They admired him and would do anything to catch his eye. The women's weakness for him only boosted his confidence further.", 0.5) with dissolve
    $ renpy.pause(5.0)
    hide screen intro_text with dissolve
...
scene story_5 at pan_zoom with dissolve
    ...
    show screen intro_text("Though the soldiers never failed in showing respect due to his rank, they understood that only his word mattered here. All they could do was follow orders, accept him as he was, and continue their days in the army.", 0.85) with dissolve
    $ renpy.pause(7.0)
    hide screen intro_text with dissolve
...
scene story_6
    ...
    show screen intro_text("Perhaps he was right, as women who secretly lusted after him, even behind their lovers' backs, wrote letters and went crazy with the desire to sleep with him.", 0.85) with dissolve
    $ renpy.pause(6.0)
    hide screen intro_text with dissolve
...
scene story_24 with dissolve
    ...
    show screen intro_text("Five days after this conversation, the soldier happened to stop by the commander's office and heard his ex-girlfriend's voice from inside. Without knocking, he entered.", 0.85) with dissolve
    $ renpy.pause(6.0)
    hide screen intro_text with dissolve
...
scene story_25 with dissolve
    ...
    show screen intro_text("He finally understood why she wanted to end their relationship—she, like the other women, had fallen for Axel.", 0.5) with dissolve
    $ renpy.pause(5.0)
    hide screen intro_text with dissolve
...
scene story_26 at pan_zoom with dissolve
    ...
    show screen intro_text("The nurse's expression made it abundantly clear how satisfied she was, finally having the man she'd dreamed of and lusted after.", 0.5) with dissolve
    $ renpy.pause(5.0)
    hide screen intro_text with dissolve
...
scene story_27 with dissolve
    ...
    show screen intro_text("She seemed completely content, screaming with pleasure as if no one else was in the room, her eyes rolling back in ecstasy.", 0.5) with dissolve
    $ renpy.pause(5.0)
    hide screen intro_text with dissolve
...
scene story_28 at pan_zoom with dissolve
    ...
    show screen intro_text("Though hard to believe, he had somehow accepted it and moved on from his ex-girlfriend. After all, they were already broken up.", 0.5) with dissolve
    $ renpy.pause(5.0)
    hide screen intro_text with dissolve
...
scene story_9 with dissolve
    ...
    show screen intro_text("Strangely, the women who initially seemed to resist him were only pretending, secretly burning with desire for him to take them. Some eagerly awaited the night, rushing to his office as soon as it got dark.", 0.5) with dissolve
    $ renpy.pause(7.0)
    hide screen intro_text with dissolve
...
scene story_11 at pan_zoom with dissolve
    ...
    show screen intro_text("His already muscular body became even more fiery with his rising libido, looking at his partner like a predator eyeing prey.", 0.5) with dissolve
    $ renpy.pause(5.0)
    hide screen intro_text with dissolve
...
scene story_10 with dissolve
    ...
    show screen intro_text("Yet, they took pride in being fucked under his massive, muscular body, craving to feel every inch of his big, warm cock inside them.", 0.5) with dissolve
    $ renpy.pause(6.0)
    hide screen intro_text with dissolve
...
scene story_12 with dissolve
    ...
    show screen intro_text("Being dominated and fucked by a sexy, wild alpha male must have been their weakness, as Axel knew this and treated each woman like she was his own while fucking them.", 0.5) with dissolve
    $ renpy.pause(7.0)
    hide screen intro_text with dissolve
...
scene story_13 with dissolve
    ...
    show screen intro_text("When Axel sensed multiple girls at his door, he'd invite them in, sometimes fucking several at once. To them, Axel was the real man.", 0.5) with dissolve
    $ renpy.pause(6.0)
    hide screen intro_text with dissolve
...
scene story_14 at pan_zoom with dissolve
    ...
    show screen intro_text("The girls would plan together and surprise him at night. The moans from his office could be heard by other soldiers, who had grown accustomed to his playboy ways and knew almost everything.", 0.5) with dissolve
    $ renpy.pause(7.0)
    hide screen intro_text with dissolve
...
scene story_15 with dissolve
    ...
    show screen intro_text("At night, he'd visit empty hospital rooms under the guise of inspection, spending time with nurses—many of whom had already been to his office and orgasmed with his big cock. To them, Axel was happiness.", 0.5) with dissolve
    $ renpy.pause(7.0)
    hide screen intro_text with dissolve
...
scene story_16 at pan_zoom with dissolve
    ...
    show screen intro_text("The girls clearly loved his massive, thick cock, their rolled-back eyes and the pleasure dripping from their pussies to his balls proving it.", 0.5) with dissolve
    $ renpy.pause(6.0)
    hide screen intro_text with dissolve
...
scene story_17 with dissolve
    ...
    show screen intro_text("Nothing was a secret anymore. Some nights, three or four girls, sometimes five or six, would go to his office without hesitation. Axel's lust had become like a plague, spreading to the girls. Their only desire was to be fucked by his massive, insatiable cock.", 0.5) with dissolve
    $ renpy.pause(10.0)
    hide screen intro_text with dissolve
...
scene story_18 at pan_zoom with dissolve
    ...
    show screen intro_text("Rising rebellions were partly due to soldiers and their families writing letters to the government, complaining about Axel's roughness.", 0.5) with dissolve
    $ renpy.pause(6.0)
    hide screen intro_text with dissolve
...
scene story_22 at pan_zoom with dissolve
    ...
    show screen intro_text("As everyone slept, the place echoed with the footsteps of black-masked government soldiers. The army had stopped protecting the state and had become like Axel's empire for his desires. The soldiers, already aware of the situation, weren't surprised.", 0.5) with dissolve
    $ renpy.pause(8.0)
    hide screen intro_text with dissolve
...
scene story_19 with dissolve
    ...
    show screen intro_text("Axel had already fled in an ambulance sent to transport an injured soldier to the city.", 0.5) with dissolve
    $ renpy.pause(5.0)
    hide screen intro_text with dissolve
...
scene story_20 at pan_zoom with dissolve
    ...
    show screen intro_text("They were so devoted to him that they'd risk their jobs and reputations to help him.", 0.5) with dissolve
    $ renpy.pause(5.0)
    hide screen intro_text with dissolve
...
scene story_21 with dissolve
    ...
    show screen intro_text("Despite his roughness, he was still Axel. They willingly helped the hero of their adrenaline-filled, dangerous sex adventures with heartfelt gratitude. The masked soldiers, hoping to catch Axel off guard in his office, were disappointed.", 0.5) with dissolve
    $ renpy.pause(8.0)
    hide screen intro_text with dissolve
...
scene story_23 with dissolve
    ...
    show screen intro_text("His cunning had saved him from this bottomless pit of sin and danger. Despite relentless searches, Axel remained unfound for days.", 0.5) with dissolve
    $ renpy.pause(5.0)
    hide screen intro_text with dissolve
...
scene story_29 at pan_zoom with dissolve
    ...
    show screen intro_text("Though the women he slept with didn't give interviews about their time with him, they secretly missed him and were sad, knowing they'd never find a man like him again. What started as love had turned into pleasure for them. It was clear the secretaries and nurses were heartbroken over his departure.", 0.5) with dissolve
    $ renpy.pause(10.0)
    hide screen intro_text with dissolve
...
scene story_30 with dissolve
    ...
    show screen intro_text("No matter how cautious or cunning he was, with his face plastered on every wall, he knew he could no longer live there and had to move to a place where no one would find him.", 0.5) with dissolve
    $ renpy.pause(7.0)
    hide screen intro_text with dissolve
...
scene story_31 at pan_zoom with dissolve
    ...
    show screen intro_text("It had beautiful nature, stunning views, and many dangerous animals.", 0.5) with dissolve
    $ renpy.pause(4.0)
    hide screen intro_text with dissolve
...
scene story_32 with dissolve
    ...
    show screen intro_text("He was aware he had to leave modern life behind.", 0.5) with dissolve
    $ renpy.pause(3.0)
    hide screen intro_text with dissolve
...
scene story_33 at pan_zoom with dissolve
    ...
    show screen intro_text("His ability to establish a life in such a dangerous forest was proof of his strength.", 0.5) with dissolve
    $ renpy.pause(4.0)
    hide screen intro_text with dissolve
