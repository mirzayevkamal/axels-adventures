init:
    ...
    define axel = Character("Axel", window_background=Transform("gui/txtbg2.png", xysize=(1920, 278), xalign=0.5, yalign=0.2),  what_size=28, what_slow_cps=30, who_xpos=-60, who_ypos=30,who_bold=True, who_color="#1a1a1a", who_size=35)
